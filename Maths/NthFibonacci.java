/*
	...
	Problem : If nth number of Fibonacci is out of the integer range then it's give wrong value.
...
public class NthFibonacci{
	...
	// Method 1: Using loop
	public static int nthFiboLoop(int n){
		// n should must be >= 0.
	...
	public static int nthFiboRecursion(int n){
		dp=new int[n+1];
	...
	private static int nthFibo(int n){
		if(n<2)
			...
			dp[n]=nthFibo(n-1)+nthFibo(n-2);
		return dp[n];
	}

	// Method 3: Using Formula
	public static int nthFiboFormula(int n){
		/*
		Formula:-
